...
public class ArrayParser {
    ...
    public ArrayParser(final Grammar gr, final Lexicon lex) {
        ...
        this.maxNSubStates = grammar.maxSubStates();
    ...
    void doInsideScores(final Tree<StateSet> tree, final boolean noSmoothing, final double[][][] spanScores) {
        ...
        for (final Tree<StateSet> subtree : tree.postOrderTraversal()) {
            ...
            if (subtree.isPreTerminal()) {
                ...
                case 1: // Unary parent
                    final StateSet child = subtree.children().get(0).label();
                ...
                case 2: // Binary parent
                    final StateSet leftChild = subtree.children().get(0).label();
                    final StateSet rightChild = subtree.children().get(1).label();
