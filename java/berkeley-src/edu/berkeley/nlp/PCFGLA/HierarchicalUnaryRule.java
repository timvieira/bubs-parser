...
public class HierarchicalUnaryRule extends UnaryRule {
    ...
    /**
     * before: scores[childSubState][parentSubState] gives score for this rule now: have a hierarchy of refinements
     */
    ...
    @Override
    public HierarchicalUnaryRule splitRule(short[] numSubStates, short[] newNumSubStates, Random random,
