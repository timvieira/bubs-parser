...
public class LBFGSMinimizer implements GradientMinimizer, Serializable {
     ...
     * @return
     */
    protected double[] doLineSearch(DifferentiableFunction function, BacktrackingLineSearcher lineSearcher,
            double[] guess, double[] direction) {
     ...
     * 
     * @param callbackFunction Will get called with the following args (double[] currentGuess, int iterDone, double
     *            value, double[] derivative) You don't have to read any or all of these.
     */
