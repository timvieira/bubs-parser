...
public class ConditionalMerger {
            ...
            for (Tree<StateSet> stateSetTree : myTrees) {
                ...
                if (consName != null) {
                    ...
                    if (cons.length != sentence.size()) {
                        System.out.println("My ID: " + myID + ", block: " + block + ", sentence: " + i);
                        System.out.println("Sentence length (" + sentence.size() + ") and constraints length ("
     ...
     * @param trainingTrees
     */
    public ConditionalMerger(int processes, String consBaseName, StateSetTreeList trainTrees, Grammar gr, Lexicon lex,
    ...
    public void mergeGrammarAndLexicon() {
        ...
        ParserData pData = new ParserData(lexicon, newGrammar, null, Numberer.getNumberers(), newGrammar.numSubStates,
                1, 0, Binarization.RIGHT);
