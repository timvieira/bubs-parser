 ...
 * external representations of labels and features are object-based. The functions getLabelIndex() and getFeatureIndex()
 * can be used to translate those objects to integer representatiosn: numbers between 0 and getNumLabels() or
 * getNumFeatures() (exclusive). The inverses of this map are the getLabel() and getFeature() functions.
 */
