 ...
 * optimization code expects one long vector for lambdas and derivatives. To go from a pair featureIndex, labelIndex to
 * a single pairIndex, use getLinearIndex().
 */
