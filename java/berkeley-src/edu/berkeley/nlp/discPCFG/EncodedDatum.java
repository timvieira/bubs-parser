 ...
 * getFeatureCount() to retreive the number and count of each non-zero feature. Use getLabelIndex() to get the label's
 * number.
 */
public class EncodedDatum {
    ...
    public static <F, L> EncodedDatum encodeLabeledDatum(Encoding<F, L> encoding, Counter<F> features, L label,
            double[] weights) {
