...
public class SpanTree<L> {
    ...
    /*
     * public SpanTree(L label, List<SpanTree<L>> children, int start, int end) { super(label, children); // TODO
     * Auto-generated constructor stub this.start = start; this.end = end; }
     */
