...
public abstract class ChartTraversal implements Iterator<ChartCell> {
	...
	static public enum ChartTraversalType {
		LeftRightBottomTopTraversal,
		LeftCornerTraversal,
		BlockedCellByPOSTraversal,
		HeuristicTraversal
	}
	...
	public static ChartTraversal create(ChartTraversalType type, ChartParser parser) {
		switch(type) {
			case  LeftRightBottomTopTraversal: return new LeftRightBottomTopTraversal(parser);
			case LeftCornerTraversal: return new LeftCornerTraversal(parser);
			case BlockedCellByPOSTraversal: return new BlockedCellByPOSTraversal(parser);
			default:
