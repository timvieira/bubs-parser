		...
		if (cell == rootChartCell) {
			...
			if (possibleEdges != null) {
				for (final ChartEdge ghostEdge : possibleEdges) {
					...
					if (curBestEdge == null) {
						...
						addEdgeToAgenda(new ChartEdgeWithFOM(ghostEdge.p, cell, ghostEdge.rightCell, prob, edgeFOM, this));
					}
				}
			}
			...
			if (possibleEdges != null) {
				for (final ChartEdge ghostEdge : possibleEdges) {
					...
					if (curBestEdge == null) {
						prob = newEdge.insideProb + ghostEdge.insideProb;
						addEdgeToAgenda(new ChartEdgeWithFOM(ghostEdge.p, ghostEdge.leftCell, cell, prob, edgeFOM, this));
					}
				}
			}
