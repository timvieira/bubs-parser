...
public class BSCPPerceptronCellTrainer extends BeamSearchChartParser<LeftHashGrammar, EdgeCellChart> {
	...
	// // final Collection<ChartEdge> goldEdgeListForGuessSpan = goldChart.getChartCell(guessSpan.start(), guessSpan.end()).getEdges();
	//
	...
	// }
	//
	// LinkedList<ChartEdge> goldEdgeListForGuessSpan = (LinkedList<ChartEdge>) goldChart.getCell(guessSpan.start(), guessSpan.end()).getEdges();
	//
	...
	// guessSpanAlreadyHasGoldEdges = guessSpanAlreadyHasGoldEdges & chart.getCell(guessSpan.start(), guessSpan.end()).hasEdge(goldEdge);
	// // System.out.println("hasGold? " + goldEdge + " chart.hasEdge=" + chart[guessSpan.start()][guessSpan.end()].hasEdge(goldEdge)
	...
	//
	// System.out.println(" sentLen=" + sent.length + " nGuessSpans=" + perceptronCellSelector.numTotal + " nCorrectSpans=" + perceptronCellSelector.numCorrect
	// + " pct=" + ((float) perceptronCellSelector.numCorrect / perceptronCellSelector.numTotal));
	// }
	// }
	// perceptronCellSelector.decreaseLearningRate();
	// System.out.println("TOTAL: total=" + totalCells + " correct=" + correctCells + " pct=" + ((float) correctCells / totalCells));
	...
	// // final Collection<ChartEdge> goldEdgeListInSpan = goldChart.getChartCell(goldEdge.start(), goldEdge.end()).getEdges();
	//
	// // final Collection<ChartEdge> allGoldEdgesInGuessSpan = goldChart.getChartCell(guessSpan.start(), guessSpan.end()).getEdges();
	...
	// // for (final ChartEdge possibleBuildableEdge : goldChart.getChartCell(guessSpan.start(), guessSpan.end()).getEdges()) {
	...
	// }
	//
	// // private void addEdgeToAgenda(final ChartEdge edge, final PriorityQueue<ChartEdge> agenda, final Collection<ChartEdge> goldEdges) {
	...
	// // }
	//
	// private int addBestEdgesToChart(final ChartCell cell, final ChartEdge[] bestEdges, final LinkedList<ChartEdge> goldEdges) {
	...
	// }
	//
	// // private int addBestEdgesToChart(final ArrayChartCell cell, final PriorityQueue<ChartEdge> agenda, final ChartEdge goldEdge) {
	...
	// // }
	// //
	// // System.out.println(" agendaSize = " + agenda.size() + " goldSize=" + goldEdges.size() + " maxEdges=" + maxEdgesToAdd);
	// //
	// // // We can sometimes not be able to build the gold edge because
	// // // (1) the viterbi max edge is not the gold edge and the gold edge gets pruned (this temp works by adding all edges to the agenda)
