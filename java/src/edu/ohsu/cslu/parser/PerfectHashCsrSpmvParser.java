...
public class PerfectHashCsrSpmvParser extends
        SparseMatrixVectorParser<PerfectHashCsrSparseMatrixGrammar, PackedArrayChart> {
    ...
    public PerfectHashCsrSpmvParser(final ParserOptions opts, final PerfectHashCsrSparseMatrixGrammar grammar) {
        super(opts, grammar);

        observedLeftChildren = new PackedBitVector(grammar.numNonTerms());
    }

    public PerfectHashCsrSpmvParser(final PerfectHashCsrSparseMatrixGrammar grammar) {
