...
public class CellConstraintsComboModel implements CellSelectorModel {
    ...
    public class CellConstraintsCombo extends CellConstraints {

        private CellConstraints constraints[];

        public CellConstraintsCombo() {
            constraints = new CellConstraints[numModels];
            for (int i = 0; i < numModels; i++) {
                constraints[i] = (CellConstraints) models[i].createCellSelector();
            }
        }
