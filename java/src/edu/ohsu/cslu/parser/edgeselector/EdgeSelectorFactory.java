...
/**
 * Represents a model for edge selection and creates edge selector instances using that model(see
 * {@link EdgeSelector}). Implementers may constrain chart cell population by lexical analysis of the sentence
