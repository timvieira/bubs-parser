...
import edu.ohsu.cslu.parser.CellwiseExhaustiveChartParser;
...
public class WeightedFeatures extends EdgeSelector {
    ...
    protected class TrainingParser extends CellwiseExhaustiveChartParser<LeftListGrammar, CellChart> {

        public TrainingParser(final ParserOptions opts, final LeftListGrammar grammar) {
            super(opts, grammar);
        }
