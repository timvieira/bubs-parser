...
public class CartesianProductLeftChildHashSpmlParser extends
    ...
    public CartesianProductLeftChildHashSpmlParser(final ParserOptions opts,
    ...
    public CartesianProductLeftChildHashSpmlParser(final LeftCscSparseMatrixGrammar grammar) {
