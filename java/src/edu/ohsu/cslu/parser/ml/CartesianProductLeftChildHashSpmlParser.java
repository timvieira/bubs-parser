 ...
 * grammar for each combination using a lookup into a segmented perfect hash.
 * 
 * @author Aaron Dunlop
 * @since Jun 14, 2010
 * 
 ...
 */
public class CartesianProductLeftChildHashSpmlParser extends SparseMatrixLoopParser<LeftCscSparseMatrixGrammar, PackedArrayChart> {
