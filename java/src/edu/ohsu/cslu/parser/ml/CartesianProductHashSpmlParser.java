 ...
 * grammar for each combination using a lookup into a perfect hash.
 * 
 * @author Aaron Dunlop
 * @since Jun 14, 2010
 * 
 ...
 */
public class CartesianProductHashSpmlParser extends SparseMatrixLoopParser<LeftCscSparseMatrixGrammar, PackedArrayChart> {
