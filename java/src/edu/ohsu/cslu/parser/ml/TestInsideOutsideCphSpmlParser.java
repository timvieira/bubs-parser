...
public class TestInsideOutsideCphSpmlParser {
    ...
    public void testM0MR() throws Exception {
        ...
        sb.append("(ROOT (S (NP (NP (JJ Influential) (NNS members)) (PP (IN of) (NP (DT the) (NP (NNP House) (NNPS Ways)) (CC and) (NP (NNP Means) (NNP Committee))))) (VP (VBD introduced) (NP (NN legislation)) (SBAR (WHNP (WDT that)) (S (VP (MD would) (VP (VB restrict) (SBAR (WHADVP (WRB how)) (S (NP (DT the) (JJ new) (NP (JJ savings-and-loan) (NN bailout) (NN agency))) (VP (MD can) (VP (VB raise) (NP (NN capital) (, ,) (VP (VBG creating) (NP (NP (DT another) (JJ potential) (NN obstacle)) (PP (TO to) (NP (DT the) (NN government) (POS 's))))) (NN sale)) (PP (IN of) (NP (JJ sick) (NNS thrifts)))))))))))) (. .)))\n");
        sb.append("(ROOT (S (NP (DT The) (NN bill)) (, ,) (SBAR (WHNP (WP$ whose) (NNS backers)) (S (VP (VB include) (NP (NP (NNP Chairman) (NNP Dan) (NNP Rostenkowski)) (PRN (-LRB- -LRB-) (NP (NP (NNP D.)) (, ,) (NNP Ill.)) (-RRB- -RRB-)))))) (, ,) (VP (MD would) (VP (VB prevent) (NP (NP (NP (NP (DT the) (NNP Resolution) (NNP Trust) (NNP Corp.)) (PP (IN from) (NP (VBG raising) (JJ temporary) (VBG working) (NN capital)))) (PP (IN by) (NP (VBG having) (NP (DT an) (JJ RTC-owned) (NN bank)) (CC or) (NN thrift)))) (NN issue) (NN debt)) (SBAR (WHNP (WDT that)) (S (VP (MD would) (RB n't) (VP (VB be) (VP (VBN counted) (PP (IN on) (NP (DT the) (JJ federal) (NN budget)))))))))) (. .)))\n");
        sb.append("(ROOT (S (NP (DT The) (NN bill)) (VP (VBZ intends) (VP (TO to) (VP (VB restrict) (NP (NP (DT the) (NNP RTC)) (PP (TO to) (NP (NNP Treasury) (NNS borrowings)))) (VP (ADVP (RB only)) (, ,) (SBAR (IN unless) (S (NP (DT the) (NN agency)) (VP (VBZ receives) (NP (JJ specific) (JJ congressional) (NN authorization))))))))) (. .)))\n");
        sb.append("(ROOT (SINV (`` ``) (NP (JJ Such) (NN agency)) (`` `) (S (NP (JJ self-help) ('' ') (NN borrowing)) (VP (VBZ is) (ADJP (ADJP (JJ unauthorized) (CC and) (JJ expensive)) (, ,) (RB far) (RBR more) (JJ expensive)) (PP (IN than) (NP (JJ direct) (NNP Treasury) (NN borrowing))))) (, ,) ('' '') (VP (VBD said) (NP (NP (NP (NNP Rep.) (NNP Fortney) (NNP Stark)) (PRN (-LRB- -LRB-) (NP (NP (NNP D.)) (, ,) (NNP Calif.)) (-RRB- -RRB-))) (, ,) (DT the) (NN bill) (POS 's))) (NP (JJ chief) (NN sponsor)) (. .)))\n");
        sb.append("(ROOT (S (NP (NP (DT The) (JJ complex) (NN financing) (NN plan)) (PP (IN in) (NP (DT the) (NN S&L) (NN bailout))) (NN law)) (VP (VBZ includes) (VP (VBG raising) (NP (NP (QP ($ $) (CD 30) (CD billion))) (PP (IN from) (NP (NN debt)))) (VP (VBN issued) (PP (IN by) (NP (DT the) (ADJP (RB newly) (VBN created)) (NNP RTC)))))) (. .)))\n");
        sb.append("(ROOT (S (NP (DT This) (NN financing) (NN system)) (VP (VBD was) (VBN created) (PP (IN in) (NP (NP (DT the) (JJ new) (NN law)) (PP (IN in) (NP (NN order))))) (VP (TO to) (VP (VB keep) (NP (DT the) (NN bailout) (NN spending)) (PP (IN from) (NP (VBG swelling) (DT the) (NN budget) (NN deficit)))))) (. .)))\n");
        sb.append("(ROOT (S (NP (DT Another) (QP ($ $) (CD 20) (CD billion))) (VP (MD would) (VP (VB be) (VBD raised) (PP (IN through) (NP (NNP Treasury) (NNS bonds))) (, ,) (SBAR (WHNP (WDT which)) (S (VP (VB pay) (NP (JJR lower) (NN interest) (NNS rates))))))) (. .)))\n");
        sb.append("(ROOT (S (CC But) (NP (DT the) (NNP RTC)) (VP (ADVP (RB also)) (VBZ requires) (`` ``) (S (NP (JJ working) ('' '') (NN capital)) (VP (TO to) (VP (VB maintain) (NP (NP (NP (DT the) (JJ bad) (NNS assets)) (PP (IN of) (NP (NNS thrifts)))) (SBAR (WHNP (WDT that)) (S (VP (VBP are) (VP (VBN sold) (, ,) (PP (IN until) (NP (DT the) (NNS assets)))))))) (VP (MD can) (VP (VB be) (VP (VBN sold) (ADVP (RB separately))))))))) (. .)))\n");
        sb.append("(ROOT (S (S (NP (DT That) (NN debt)) (VP (MD would) (VP (VB be) (VBN paid) (PRT (RP off)) (PP (IN as) (NP (DT the) (NNS assets))))) (VP (VBP are) (VP (VBN sold) (, ,) (VBG leaving) (NP (DT the) (JJ total) (NN spending)) (PP (IN for) (NP (NP (DT the) (NN bailout)) (PP (IN at) (NP (QP ($ $) (CD 50) (CD billion))))))))) (, ,) (CC or) (NP (QP ($ $) (CD 166) (CD billion))) (VP (VBG including) (NP (NN interest)) (PP (IN over) (NP (CD 10) (NNS years)))) (. .)))\n");
        sb.append("(ROOT (SINV (`` ``) (S (NP (PRP It)) (VP (VBZ 's) (NP (DT a) (NN problem)) (SBAR (WHNP (WDT that)) (S (ADVP (RB clearly)) (VP (VBZ has) (VP (TO to) (VP (VB be) (VP (VBN resolved))))))))) (, ,) ('' '') (VP (VBD said) (NP (NNP David) (NNP Cooke) (, ,))) (NP (NP (JJ executive) (NN director)) (PP (IN of) (NP (DT the) (NNP RTC)))) (. .)))\n");
        sb.append("(ROOT (S (NP (DT The) (NN agency)) (VP (VBZ has) (RB already) (VP (VBN spent) (S (S (NP (QP (RB roughly) ($ $) (CD 19) (CD billion))) (VP (VBG selling) (NP (CD 34) (JJ insolvent) (NNS S&Ls)))) (, ,) (CC and) (S (NP (PRP it)) (VP (VBZ is) (RB likely) (VP (TO to) (VP (VB sell) (CC or) (VB merge) (NP (CD 600)) (PP (IN by) (NP (DT the) (NN time))))))) (NP (DT the) (NN bailout)) (VP (VBZ concludes)) (. .))))))\n");
        sb.append("(ROOT (S (PP (IN Absent) (NP (JJ other) (VBG working) (NN capital))) (, ,) (NP (PRP he)) (VP (VBD said) (S (, ,) (NP (DT the) (NNP RTC)) (VP (MD would) (VP (VB be) (VP (VBN forced) (VP (TO to) (VP (VB delay) (NP (NP (JJ other) (NN thrift) (NNS resolutions)) (PP (IN until) (NP (NN cash))))))))) (VP (MD could) (VP (VB be) (VP (VBN raised) (PP (IN by) (NP (VBG selling) (DT the) (JJ bad) (NNS assets)))))))) (. .)))\n");
        sb.append("(ROOT (S (`` ``) (NP (PRP We)) (VP (MD would) (VP (VBP have) (VP (TO to) (VP (VB wait) (PP (IN until) (NP (PRP we))) (VP (VBP have) (VP (VBN collected) (PP (IN on) (NP (NP (DT those) (NNS assets)) (PP (IN before) (NP (PRP we))))))))))) (VP (MD can) (VP (VB move) (PRT (RP forward)) (S (, ,) ('' '') (NP (PRP he)) (VP (VBD said)) (. .))))))\n");
        ...
        sb.append("(ROOT (S (ADVP (RB Moreover)) (, ,) (S (NP (PRP it)) (VP (VBZ says) (NP (DT the) (NNP RTC) (POS 's)))) (S (NP (JJ total) (NNS obligations)) (VP (MD may) (RB not) (VP (VB exceed) (NP (QP ($ $) (CD 50) (CD billion)))))) (, ,) (CC but) (S (NP (DT that) (NN figure)) (VP (VBZ is) (VP (VBN derived) (PP (IN after) (NP (VBG including) (NNS notes)))))) (CC and) (S (NP (JJ other) (NN debt)) (VP (, ,) (CC and) (PP (VBG subtracting) (PP (IN from) (NP (PRP it)))))) (NP (NP (DT the) (NN market) (NN value)) (PP (IN of) (NP (DT the) (NNS assets)))) (NP (DT the) (NNP RTC)) (VP (VBZ holds)) (. .)))\n");
        sb.append("(ROOT (S (CC But) (NP (NNP Congress)) (VP (VBD did) (RB n't) (VP (VBP anticipate) (VP (CC or) (VB intend) (NP (NP (JJR more) (JJ public) (NN debt)) (PRN (, ,) (SINV (VP (VBP say) (NP (NNS opponents)) (PP (IN of) (NP (DT the) (NNP RTC) (POS 's)))) (NP (NP (JJ working-capital) (NN plan) (, ,)) (CC and) (NP (NP (NNP Rep.) (NNP Charles) (NNP Schumer)) (PRN (-LRB- -LRB-) (NNP D.) (, ,)) (NNP N.Y))) (. .)) (-RRB- -RRB-))) (VP (VBD said) (NP (DT the) (NNP RTC) (NNP Oversight) (NNP Board)) (VP (VBZ has) (VP (VBN been) (PP (JJ remiss) (IN in) (ADVP (RB not))) (VP (VBG keeping) (NP (NNP Congress)) (VP (VBN informed))))))))) (. .)))\n");
        sb.append("(ROOT (S (`` ``) (S (NP (DT That) (NN secrecy)) (VP (VBZ leads) (PP (TO to) (NP (NP (NP (NP (DT a) (NN proposal)) (PP (IN like) (NP (DT the) (NN one)))) (PP (IN from) (NP (NP (NNPS Ways) (CC and) (NNPS Means)) (, ,) (SBAR (WHNP (WDT which)) (S (VP (VBZ seems) (PP (TO to) (NP (PRP me)))))) (NN sort)))) (PP (IN of) (NP (JJ draconian))))))) (, ,) ('' '') (NP (PRP he)) (VP (VBD said)) (. .)))\n");
        sb.append("(ROOT (S (`` ``) (NP (DT The) (NNP RTC)) (VP (VBZ is) (VP (VBG going) (VP (TO to) (VP (VBP have) (VP (TO to) (VP (VB pay) (S (NP (NP (NP (DT a) (NN price)) (PP (IN of) (NP (JJ prior) (NN consultation)))) (PP (IN on) (NP (NP (DT the) (NNP Hill)) (PP (IN if) (NP (PRP they)))))) (VP (VB want) (NP (DT that) (NN kind)) (PP (IN of) (NP (NN flexibility)))) (. .)))))))) ('' '')))\n");
        ...
        GlobalConfigProperties.singleton().setProperty(Parser.PROPERTY_MAXC_LAMBDA, "0");
        parser = new InsideOutsideCphSpmlParser(opts, new InsideOutsideCscSparseMatrixGrammar(
