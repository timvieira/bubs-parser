...
public class GrammarLoopSpmlParser extends SparseMatrixLoopParser<CsrSparseMatrixGrammar, DenseVectorChart> {
    ...
    public GrammarLoopSpmlParser(final ParserOptions opts, final CsrSparseMatrixGrammar grammar) {
        super(opts, grammar);
    }

    public GrammarLoopSpmlParser(final CsrSparseMatrixGrammar grammar) {
