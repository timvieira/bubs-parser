...
public class PackedOpenClSpmvParser extends OpenClSpmvParser<PackedArrayChart> {
    ...
    public PackedOpenClSpmvParser(final ParserOptions opts, final CsrSparseMatrixGrammar grammar) {
        ...
        clTmpCellInsideProbabilities = context.createFloatBuffer(CLMem.Usage.InputOutput, grammar
            .numNonTerms());
    ...
    protected void finalizeCell(final ParallelArrayChartCell chartCell) {
        ...
        prefixSumKernel.setArgs(clTmpCellInsideProbabilities, clPrefixSum, clChartNumNonTerminals, chart
            .cellIndex(packedCell.start(), packedCell.end()), grammar.numNonTerms());
