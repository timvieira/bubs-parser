...
public class PerfectShortPair2IntHash implements ImmutableShortPair2IntHash {
     ...
     * @param modulus
     */
    public PerfectShortPair2IntHash(final short[][] keyPairs, final int modulus) {
    ...
    public PerfectShortPair2IntHash(final short[][] keyPairs) {
        this(keyPairs, 0);
    }
    ...
    public short unsafeKey1(final int hashcode) {
        return (short) (hashtable[hashcode] >> packingShift);
    }
    ...
    public short unsafeKey2(final int hashcode) {
        return (short) (hashtable[hashcode] & packingMask);
    }
