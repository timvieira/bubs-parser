...
public class TestStrings {
    ...
    public void testExtractPos() throws Exception {
        String parseTree = "(TOP (S (NP (NN Delivery)) (VP (AUX is) (S (VP (TO to)" + " (VP (VB begin) (PP (IN in) (NP (JJ early) (CD 1991))))))) (. .)))";
        String pos = "(NN Delivery) (AUX is) (TO to) (VB begin) (IN in) (JJ early) (CD 1991) (. .)";
        assertEquals(pos, Strings.extractPos(parseTree));

        parseTree = "(TOP (S (SBAR (IN Although) (S (NP (JJ preliminary) (NNS findings))" + " (VP (AUX were) (VP (VBN reported) (ADVP (NP (QP (RBR more) (IN than) (DT a))"
                + " (NN year)) (IN ago)))))) (, ,) (NP (DT the) (JJS latest) (NNS results))" + " (VP (VBP appear) (PP (IN in) (NP (NP (NP (NP (NN today) (POS 's)) (NNP New)"
                + " (NNP England) (NNP Journal)) (PP (IN of) (NP (NNP Medicine)))) (, ,)" + " (NP (NP (DT a) (NN forum)) (ADJP (JJ likely) (S (VP (TO to) (VP (VB bring)"
                + " (NP (JJ new) (NN attention)) (PP (TO to) (NP (DT the) (NN problem))))))))))) (. .)))";
        pos = "(IN Although) (JJ preliminary) (NNS findings) (AUX were)" + " (VBN reported) (RBR more) (IN than) (DT a) (NN year) (IN ago) (, ,) (DT the)"
                + " (JJS latest) (NNS results) (VBP appear) (IN in) (NN today) (POS 's) (NNP New)" + " (NNP England) (NNP Journal) (IN of) (NNP Medicine) (, ,) (DT a) (NN forum)"
    ...
    public void testExtractPosAndHead() throws Exception {
        ...
        parseTree = "(TOP (S (SBAR (IN Although) (S (NP (JJ preliminary) (NNS findings))" + " (VP (AUX were) (VP (VBN reported) (ADVP (NP (QP (RBR more) (IN than) (DT a))"
                ...
                + " (NNP England) (NNP Journal)) (PP (IN of) (NP (NNP Medicine)))) (, ,)" + " (NP (NP (DT a) (NN forum)) (ADJP (JJ likely) (S (VP (TO to) (VP (VB bring)"
                + " (NP (JJ new) (NN attention)) (PP (TO to) (NP (DT the) (NN problem))))))))))) (. .)))";
        pos = "(IN Although NONHEAD) (JJ preliminary NONHEAD) (NNS findings NONHEAD)" + " (AUX were NONHEAD) (VBN reported NONHEAD) (RBR more NONHEAD) (IN than NONHEAD)"
                + " (DT a NONHEAD) (NN year NONHEAD) (IN ago NONHEAD) (, , NONHEAD) (DT the NONHEAD)"
                + " (JJS latest NONHEAD) (NNS results NONHEAD) (VBP appear HEAD) (IN in NONHEAD)" + " (NN today NONHEAD) (POS 's NONHEAD) (NNP New NONHEAD) (NNP England NONHEAD)"
                + " (NNP Journal NONHEAD) (IN of NONHEAD) (NNP Medicine NONHEAD) (, , NONHEAD)" + " (DT a NONHEAD) (NN forum NONHEAD) (JJ likely NONHEAD) (TO to NONHEAD)"
                + " (VB bring NONHEAD) (JJ new NONHEAD) (NN attention NONHEAD) (TO to NONHEAD)" + " (DT the NONHEAD) (NN problem NONHEAD) (. . NONHEAD)";
        assertEquals(pos, Strings.extractPosAndHead(parseTree, ruleset));
    }
    ...
    public void testFeaturePairs() throws Exception {
        ...
        // Two-element string
        assertEquals(new TreeSet<String>(Arrays.asList(new String[] { "(foo) (bar)" })), Strings.featurePairs("(foo) (bar)"));
    ...
    public void testPermuteFeatures() throws Exception {
        final Set<String> permutations = Strings.permuteFeatures("(Entire _capitalized) (day) (para-sailing _hyphenated)");
