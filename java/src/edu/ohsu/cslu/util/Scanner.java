...
public interface Scanner {
    ...
    public static enum Operator {
        SUM, MAX, MIN, LOGICAL_AND, LOGICAL_NAND;
    }
    ...
    /**
     * Performs an exclusive segmented prefix scan of the input array, using the specified operator. The scan is segmented at each non-zero value in the flag array.
     * 
     * @param input
     * @param flags Segment delimiters. Each non-zero value denotes the end of a segment.
     * @param operator
     * @return Result of the scan; an array of the same size as the input.
     */
    ...
    /**
     * Performs an exclusive prefix scan of the input array, using the specified operator, and storing the results in a result array.
     * 
     * @param input
     * @param result Result array; must be the same length as the input array
     * @param fromIndex Start index, inclusive
     * @param toIndex End index, exclusive
     * @param operator
     */
    ...
    /**
     * Performs an inclusive segmented prefix scan of the input array, using the specified operator. The scan is segmented at each non-zero value in the flag array.
     * 
     * @param input
     * @param segmentFlags Segment delimiters. Each non-zero value denotes the end of a segment.
     * @param operator
     * @return Result of the scan; an array of the same size as the input.
     */
    ...
    /**
     * Performs an inclusive prefix scan of the input array, using the specified operator, and storing the results in a result array.
     * 
     * @param input
     * @param result Result array; must be the same length as the input array
     * @param fromIndex Start index, inclusive
     ...
     * 
     * @param input
     * @param indices Indices for the scattered array. The index array must be the same length as the input array.
     ...
     * @param input
     * @param indices Indices for the scattered array. The index array must be the same length as the input array.
     * @param flags Flags of which input values should be scattered. Non-zero values are considered 'flagged'. The flags array must be the same length as the input array.
     * @return Scattered array
     */
     ...
     * 
     * @param input
     * @param result Target array. Must be large enough to contain the maximum index from indices.
     * @param indices Indices for the scattered array. The index array must be the same length as the input array.
     * @param flags Flags of which input values should be scattered. Non-zero values are considered 'flagged'. The flags array must be the same length as the input array.
     */
    ...
    /**
     * Performs a custom inclusive scan on a parallel array of float[] and short[]. Within each segment, the it chooses the max of the floats and 'carries-along' the short value
     * which occurs at the maximum float encountered.
     * 
     * @param floatInput
     * @param floatResult Target float array. Must be the same size as the input arrays.
     * @param shortInput
     * @param shortResult Target short array. Must be the same size as the input arrays.
     * @param segmentFlags Segment delimiters. Each non-zero value denotes the end of a segment.
     */
    ...
    /**
     * Flags the final instance of each key in a series. e.g. 1, 2, 2, 3, 3, 3, 4 will be flagged 1, 0, 1, 0, 0, 1.
     * 
     * TODO Implement a version that returns a packed bit vector
     * 
     * @param input
     * @param result Flags (1 = flagged, 0 = un-flagged)
     */
