...
public class ApproximateMatch
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Naive Exact Algorithm: " + matches + " matches in " + ((endTime - startTime) / 1000000)
            + " milliseconds (" + ((endTime - startTime) / 1000) + " microseconds)");
        ...
        endTime = System.nanoTime();
        System.out
            .println("Linear Space Dynamic Programming Algorithm: " + matches + " matches in "
                + ((endTime - startTime) / 1000000) + " milliseconds (" + ((endTime - startTime) / 1000)
                + " microseconds)");
        ...
        endTime = System.nanoTime();
        System.out
            .println("Aho-Corasick (Baeza-Yates/Perlberg) Algorithm: " + matches + " matches in "
                + ((endTime - startTime) / 1000000) + " milliseconds (" + ((endTime - startTime) / 1000)
                + " microseconds)");
