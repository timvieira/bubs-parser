...
/**
 * Aligns a sequence according to a Position-Specific Score Matrix by inserting gaps in the sequence to match
 * the modeled length.
 * 
 * @author Aaron Dunlop
 * @since Jul 4, 2008
...
public abstract class BaseColumnAligner implements ColumnSequenceAligner {
    ...
    /**
     * Returns the number of character matches found between the two strings supplied. (e.g. matches("aaa",
     * "aaa") will return 3, and matches("abc", "abd") will return 2).
     * 
