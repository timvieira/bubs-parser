...
public class TestMultipleSequenceAligners
{
    ...
    public static void suiteSetUp() throws Exception
    {
        ...
        linguisticAlignmentModel = new MatrixSubstitutionAlignmentModel(new DenseMatrix[] {matrix0, matrix1},
    ...
    public void testDnaAlignment() throws Exception
    {
        ...
        final DenseMatrix matrix2 = new IntMatrix(new int[][] { {3, 99, 99, 98, 99, 200}, {93, 26, 95, 90, 94, 500},
            {93, 94, 29, 92, 89, 500}, {93, 91, 94, 25, 94, 500}, {92, 92, 87, 91, 34, 500}, {92, 75, 80, 69, 81, 500}});
        final AlignmentModel model2 = new MatrixSubstitutionAlignmentModel(matrix2, DNA_VOCABULARY);
        final MultipleSequenceAlignment alignedSequences = aligner
            .align(sampleSequences2, levenshteinDistances, model2);
    ...
    public void testLinguisticAlignment() throws Exception
    {
        ...
        final MappedSequence sequence2 = new MultipleVocabularyMappedSequence(Strings.extractPos(sampleSentence16),
            linguisticVocabularies);
        final MappedSequence sequence3 = new MultipleVocabularyMappedSequence(Strings.extractPos(sampleSentence8),
            linguisticVocabularies);
