...
/**
 * Represents a priority queue of distance measures. Useful for such tasks as progressive pairwise alignment,
 * in which we align the closest two sequences, followed by the next closest unaligned, and so on (see
 * {@link IterativePairwiseAligner}.
 * 
 * @author Aaron Dunlop
 * @since May 8, 2009
 * 
...
public interface PairwiseDistanceHeap {
     ...
     * @param distance
     *            Distance between the two elements. The distance must be between 0 and 1 inclusive.
    ...
    /**
     * Retrieves and deletes the closest distance stored in the heap. The pair of indices are returned as a
    ...
    /**
     * Retrieves and deletes the closest distance stored in the heap. Note that {@link #deleteMin()} is
     * generally more efficient if you do not need the actual distance.
     * 
