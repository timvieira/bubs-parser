 ...
 * 
 * This class is generally useful to store binary feature vectors in which a considerable portion of the bits
 * will be populated - if only a small number of bits are likely to be populated, {@link SparseBitVector} will
