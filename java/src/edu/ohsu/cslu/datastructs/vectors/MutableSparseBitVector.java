...
/**
 * Implementation of the {@link BitVector} interface which stores the indices of populated bits in an
 * {@link IntSet}.
 * 
 * This class is generally useful to store mutable binary feature vectors in which a few of the bits will be
 * populated - if a large number of bits are likely to be populated, {@link PackedBitVector} will likely be
 * more efficient.
 * 
...
public class MutableSparseBitVector extends BaseVector implements BitVector {
    ...
    /**
     * Constructs a {@link SparseBitVector} from an integer array. Note that the semantics of this constructor
    ...
    /**
     * Exposes the internal {@link IntSet} for use by other {@link Vector} implementations within the vector
     * package.
     * 
     * @return IntSet
     */
