 ...
 * 
 * A {@link BitVector} is generally useful to store binary feature vectors (e.g. for log-linear modeling) and
 * boolean sets.
 * 
 * In addition to the normal {@link Vector} methods, it also declares convenience methods named in standard
 * set convention.
 * 
 * @author Aaron Dunlop
 * @since Mar 23, 2009
...
public interface BitVector extends Vector {
     ...
     * <ol>
     * <li>For implementations of fixed-size, such as {@link PackedBitVector}, the highest index which the
     * vector can store.
     * <li>For implementations of variable size, such as {@link MutableSparseBitVector}, the highest populated
     * index + 1.
     * </ol>
     * 
     * @return length.
