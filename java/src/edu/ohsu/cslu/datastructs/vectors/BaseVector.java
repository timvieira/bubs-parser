...
public abstract class BaseVector implements Vector, Serializable {
    ...
    /**
     * Creates a new {@link Vector} of the specified length and of a type appropriate to return from integer
     * operations ({@link #scalarAdd(int)}, {@link #scalarMultiply(int)}, etc.) This method will be overridden
     * by floating-point {@link Vector} implementations, by {@link PackedIntVector}, and by sparse storage
     * implementations.
     * 
     * @return Vector
     */
    ...
    /**
     * Creates a new {@link Vector} of the same length and of a type appropriate to return from integer
     * operations.
     * 
     * @return Vector
     */
     ...
     * floating-point operations ({@link #scalarAdd(float)}, {@link #scalarMultiply(float)}, etc.) This method
     * may be overridden by some {@link Vector} implementations.
     * 
     * @return Vector
     */
     ...
     * operations ({@link #scalarAdd(float)}, {@link #scalarMultiply(float)}, etc.) This method may be
     * overridden by some {@link Vector} implementations.
     * 
     * @return Vector
     */
