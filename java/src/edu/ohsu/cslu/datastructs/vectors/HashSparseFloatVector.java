...
public class HashSparseFloatVector extends BaseNumericVector {
    ...
    /**
     * Initializes a {@link HashSparseFloatVector} from a floating-point array. Vector indices and values are
     * assumed to be in sorted order in adjacent array slots. (e.g, {2, 4, 5, 8} represents a Vector of length
     * 6 in which 2 elements are present). The length of the vector is the final populated index.
     * 
     * @param vector
     *            The populated vector elements in index, value tuples.
     */
