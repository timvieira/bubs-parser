...
public abstract class DenseIntMatrixTestCase extends IntMatrixTestCase implements DenseMatrixTestCase {
    ...
    public void testGetRow() {
        ...
        assertArrayEquals(new float[] { 67, 78, 89, 100, 13 }, ((DenseMatrix) symmetricMatrix).getRow(3), .01f);
    ...
    public void testGetColumn() {
        ...
        assertArrayEquals(new float[] { 0, 11, 33, 67, 10 }, ((DenseMatrix) symmetricMatrix).getColumn(0), .01f);
        assertArrayEquals(new float[] { 33, 44, 56, 89, 12 }, ((DenseMatrix) symmetricMatrix).getColumn(2), .01f);
        assertArrayEquals(new float[] { 10, 11, 12, 13, 14 }, ((DenseMatrix) symmetricMatrix).getColumn(4), .01f);
    }
