...
public abstract class DenseFloatingPointMatrixTestCase extends FloatingPointMatrixTestCase implements
    ...
    public void testGetRow() {
        assertArrayEquals(new float[] { 11.11f, 22.22f, 33.33f, 44.44f }, ((DenseMatrix) sampleMatrix)
            .getRow(0), .01f);
        assertArrayEquals(new float[] { 55.55f, 66.66f, 77.77f, 88.88f }, ((DenseMatrix) sampleMatrix)
            .getRow(1), .01f);
        assertArrayEquals(new float[] { 0, 11.11f, 33.33f, 66.66f, 10f }, ((DenseMatrix) symmetricMatrix)
            .getRow(0), .01f);
    ...
    public void testGetColumn() {
        assertArrayEquals(new float[] { 11.11f, 55.55f, 99.99f }, ((DenseMatrix) sampleMatrix).getColumn(0),
            .01f);
        assertArrayEquals(new float[] { 44.44f, 88.88f, 12.11f }, ((DenseMatrix) sampleMatrix).getColumn(3),
            .01f);
        assertArrayEquals(new float[] { 0, 11.11f, 33.33f, 66.66f, 10f }, ((DenseMatrix) symmetricMatrix)
            .getColumn(0), .01f);
    ...
    public void testSetRow() {
        ...
        assertArrayEquals(new float[] { 2.3f, 2.3f, 2.3f, 2.3f }, ((DenseMatrix) sampleMatrix2).getRow(2),
            .01f);
        ...
        assertArrayEquals(new float[] { 1.1f, 2.2f, 3.3f, 4.4f, 5.0f }, ((DenseMatrix) symmetricMatrix)
            .getRow(0), .01f);
        ...
        assertArrayEquals(new float[] { 10.1f, 11.1f, 12.1f, 13.1f, 14.1f }, ((DenseMatrix) symmetricMatrix)
            .getRow(4), .01f);

        ((DenseMatrix) symmetricMatrix2).setRow(4, 1.51f);
        assertArrayEquals(new int[] { 2, 2, 2, 2, 2 }, ((DenseMatrix) symmetricMatrix2).getIntRow(4));
        assertArrayEquals(new float[] { 1.51f, 1.51f, 1.51f, 1.51f, 1.51f }, ((DenseMatrix) symmetricMatrix2)
            .getRow(4), .01f);
    }
    ...
    public void testSetColumn() {
        ...
        assertArrayEquals(new float[] { 13.1f, 14.1f, 15.1f }, ((DenseMatrix) sampleMatrix).getColumn(0),
            .01f);
        ...
        assertArrayEquals(new float[] { 1.1f, 2.2f, 3.3f, 4.4f, 5.5f }, ((DenseMatrix) symmetricMatrix)
            .getColumn(0), .01f);
