...
public interface DenseMatrix extends Matrix {
    ...
    /**
     * Retrieves a row. Note that {@link Matrix} implementations may return a copy of the actual row or may
     * return a reference to the row itself. Consumers should make their own copy before altering the returned
     * array. Read-only access is safe.
     * 
     * @param i
     *            row
    ...
    /**
     * Retrieves a column. Note that {@link Matrix} implementations may return a copy of the actual row or may
     * return a reference to the row itself. Consumers should make their own copy before altering the returned
     * array. Read-only access is safe.
     * 
     * @param j
     ...
     *            row
     * @param value
     *            value with which to fill the specified row
     */
     ...
     *            column
     * @param value
     *            value with which to fill the specified column
     */
     ...
     *             if a submatrix index is outside of this matrix
     */
