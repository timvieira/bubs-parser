...
@RunWith(Suite.class)
@Suite.SuiteClasses( {TestFloatingPointLongPairwiseDistanceHeap.class, TestFixedPointLongPairwiseDistanceHeap.class,
                      AllMatrixTests.class, AllVectorTests.class, AllTreeTests.class})
