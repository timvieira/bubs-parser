 ...
 * 
 * This implementation stores the distance as a 16-bit fixed-point and the two indices as unsigned
 * 24-bit integers (for a similar floating-point implementation, see
 * {@link FloatingPointLongPairwiseDistanceHeap}).
 * 
 * @author Aaron Dunlop
 * @since May 8, 2009
 * 
...
public class FixedPointLongPairwiseDistanceHeap extends BaseLongPairwiseDistanceHeap
{
    ...
    public void insert(int index1, int index2, float distance)
    {
        ...
        final long l = (((long) (distance * DIVISOR)) << 48) | ((index1 & 0xffffffl) << 24) | (index2 & 0xffffff);
