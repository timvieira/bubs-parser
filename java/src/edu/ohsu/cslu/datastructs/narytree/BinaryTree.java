...
public class BinaryTree<E> implements Tree<E>, Serializable {
	...
	public boolean equals(final Object o) {
		...
		if ((rightChild == null && other.rightChild != null) || (rightChild != null && !rightChild.equals(other.rightChild))) {
			return false;
		}
	 ...
	 * @param type
	 *            The node label class
	 * @param factorization
	 *            The binary factorization method
	 * @return the tree
	 * @throws IOException
	 *             if the read fails
	 */
	public static <T> BinaryTree<T> read(final InputStream inputStream, final Class<T> type, final Factorization factorization) throws IOException {
	 ...
	 *             if the read fails
	 */
	public static <T> BinaryTree<T> read(final InputStream inputStream, final LabelParser<T> labelParser, final Factorization factorization) throws IOException {
	 ...
	 *             if the read fails
	 */
	public static <T> BinaryTree<T> read(final InputStream inputStream, final LabelParser<T> labelParser) throws IOException {
	 ...
	 * @return the tree
	 */
	public static <T> BinaryTree<T> read(final String string, final LabelParser<T> labelParser, final Factorization factorization) {
		try {
	 ...
	 *             if the read fails
	 */
	public static <T> BinaryTree<T> read(final Reader reader, final Class<T> type, final Factorization factorization) throws IOException {
	 ...
	 *             if the read fails
	 */
	public static <T> BinaryTree<T> read(final Reader reader, final LabelParser<T> labelParser, final Factorization factorization) throws IOException {
		char c;
	 ...
	 *             if the read fails
	 */
	private static <T> BinaryTree<T> readSubtree(final Reader reader, final BinaryTree<T> parent, final LabelParser<T> labelParser, final Factorization factorization)
			throws IOException {
