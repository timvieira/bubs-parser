...
public class TestIntShiftRegister
{
    ...
    public void testShift()
    {
        ...
        assertArrayEquals(new int[] {Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE,
            Integer.MIN_VALUE}, register.register());

        register = register.shift(5);
        assertArrayEquals(new int[] {Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, 5},
            register.register());

        register = register.shift(4);
        assertArrayEquals(new int[] {Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, 5, 4}, register
            .register());
