...
public class TestParseTree
{
    ...
    /**
     * Tests Charniak / Magerman style head-percolation (headDescendant(), headLevel(), and
     * isHeadOfTreeRoot() methods)
     * 
     * @throws Exception if something bad happens
     */
    @Test
    public void testHeadPercolation() throws Exception
    {
        ...
        assertEquals("industrial", s.subtree("NP").subtree("JJ").subtree("industrial").headDescendant(charniakRuleset)
            .label());
