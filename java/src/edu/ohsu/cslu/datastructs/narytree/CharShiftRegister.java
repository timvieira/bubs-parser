...
/**
 * Implements a simple shift register of fixed size. Character elements are inserted at the end of
 * the register, shifting current contents leftward. The concept is similar to that of a queue, and
 * is described in [Augsten, Bohlen, Gamper 2005] Implemented in order to support their pq-Grams
 * algorithm.
 * 
 * This implementation is specifically intended for testing; in particular, it should make testing
 * the examples from the Augsten et al paper easier.
 * 
