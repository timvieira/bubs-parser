...
/**
 * Generic NaryTree implementation. The interface is defined recursively (children of an {@link NaryTree} are
 * also {@link NaryTree}s, rather than defining an explicit Node class)
 * 
...
public class NaryTree<E> implements Tree<E>, Serializable {
     ...
     * @throws IOException if the read fails
     */
    public static <T> NaryTree<T> read(final Reader reader, final LabelParser<T> labelParser)
            throws IOException {
        char c;
