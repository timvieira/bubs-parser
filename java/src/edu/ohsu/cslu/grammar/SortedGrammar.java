 ...
 * occurrence in binary rules. This can allow more efficient iteration in grammar intersection (e.g., skipping NTs only
 * valid as left children in the right cell) and more efficient chart storage (e.g., omitting storage for POS NTs in
 * chart rows >= 2).
 * 
 * @author Aaron Dunlop
 * @since Jun 6, 2010
