...
public class SerializeModel extends BaseCommandlineTool {
    ...
    @Option(name = "-d", metaVar = "options", usage = "Default options to be serialized into the file (key=value)")
    ...
    protected void run() throws Exception {
        ...
        Grammar g = new ListGrammar(grammarReader, new DecisionTreeTokenClassifier());
