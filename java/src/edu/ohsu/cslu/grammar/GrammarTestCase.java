...
public abstract class GrammarTestCase {
	...
	public static <C extends Grammar> C createGrammar(final Class<C> grammarClass, final Reader grammarReader, final Reader lexiconReader) throws Exception {
	...
	public static <C extends Grammar> C createGrammar(final Class<C> grammarClass, final Reader grammarReader, final Reader lexiconReader,
			final Class<? extends SparseMatrixGrammar.CartesianProductFunction> cartesianProductFunctionClass) throws Exception {

		try {
			return grammarClass.getConstructor(new Class[] { Reader.class, Reader.class, GrammarFormatType.class, Class.class }).newInstance(
					new Object[] { grammarReader, lexiconReader, GrammarFormatType.CSLU, cartesianProductFunctionClass });
	...
	public static Grammar createSimpleGrammar(final Class<? extends Grammar> grammarClass, final Class<? extends CartesianProductFunction> cartesionProductFunctionClass)
			throws Exception {
		...
		return createGrammar(grammarClass, new StringReader(grammarSb.toString()), new StringReader(lexiconSb.toString()), cartesionProductFunctionClass);
	}
