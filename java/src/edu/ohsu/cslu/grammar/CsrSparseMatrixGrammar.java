...
public class CsrSparseMatrixGrammar extends SparseMatrixGrammar {
	...
	/**
	 * Column indices of each matrix entry in {@link #csrBinaryProbabilities}. One entry for each binary rule; the same size as {@link #csrBinaryProbabilities}.
	 */
	...
	public CsrSparseMatrixGrammar(final Reader grammarFile, final Reader lexiconFile, final GrammarFormatType grammarFormat,
	...
	protected void storeBinaryRulesAsCsrMatrix(final int[] csrRowIndices, final int[] csrColumnIndices, final float[] csrProbabilities) {
