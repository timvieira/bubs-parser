...
public class RightCscSparseMatrixGrammar extends CscSparseMatrixGrammar {
	...
	public RightCscSparseMatrixGrammar(final Reader grammarFile, final Reader lexiconFile, final GrammarFormatType grammarFormat) throws Exception {
	...
	public RightCscSparseMatrixGrammar(final String grammarFile, final String lexiconFile, final GrammarFormatType grammarFormat) throws Exception {
