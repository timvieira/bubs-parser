...
public class LeftListEvalGrammar extends LeftListGrammar {
    ...
    public LeftListEvalGrammar(final String grammarFile) throws Exception {
        super(grammarFile);
    ...
    //
    // public LeftListEvalGrammar(final Reader grammarFile, final Reader lexiconFile, final GrammarFormatType
    // grammarFormat) throws Exception {
