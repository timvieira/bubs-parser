...
public class TestSelectFeatures extends ToolTestCase {
    ...
    public void testBracketedInput() throws Exception {
        ...
        assertEquals("(they _capitalized) (are) (10-lap _hyphenated) (mcs _capitalized _all_caps) (.)\n",
            executeTool(new SelectFeatures(), "-i bracketed -wi 2 -lcw -hyphen -cap -allcaps",
                hyphenatedInput));
    ...
    public void testTreeInput() throws Exception {
        ...
        assertEquals(
            "(they _capitalized) (are) (10-lap _hyphenated) (mcs _capitalized _all_caps) (.)\n",
            executeTool(new SelectFeatures(), "-i bracketed-tree -lcw -hyphen -cap -allcaps", hyphenatedInput));
        ...
        assertEquals(
            ...
            executeTool(new SelectFeatures(), "-lcw -i bracketed-tree -prevword 2 -subword 1", oneLineInput));
        ...
        assertEquals(
            ...
            executeTool(new SelectFeatures(), "-lcw -i bracketed-tree -prevword 1 -prevpos 1 -subpos 1",
                oneLineInput));
        ...
        assertEquals(
            "(sometimes _pos_RB _before_head) (they _pos_PRP _before_head) (are _pos_AUX _head_verb) (constructive _pos_JJ _after_head)"
                    + " (, _pos_, _after_head) (but _pos_CC _after_head) (often _pos_RB _after_head) (not _pos_RB _after_head) (. _pos_. _after_head)\n",
            executeTool(new SelectFeatures(), "-i square-bracketed-tree -lcw -p -h -bh -ah", oneLineInput
        ...
        assertEquals(
            "sometimes/RB they/PRP are/AUX constructive/JJ ,/, but/CC often/RB not/RB ./.\n"
    ...
    /**
     * Tests running the tool with multiple threads. Not a very useful scenario for {@link SelectFeatures},
     * but a reasonable test for the threading of {@link LinewiseCommandlineTool}.
     * 
     * @throws Exception
     */
    @Test
    public void testMultiThreaded() throws Exception {
        ...
        final String expectedOutput = new String(SharedNlpTests
            .readUnitTestData("tools/select-features.output"));
