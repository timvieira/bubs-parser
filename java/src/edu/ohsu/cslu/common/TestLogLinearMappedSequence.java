 ...
 * 
 * TODO: Merge shared test code with {@link TestLogLinearMappedSequence} (once the {@link Sequence} interface
...
public class TestLogLinearMappedSequence {
    ...
    public void testConstructors() throws Exception {
        LogLinearMappedSequence sequence = new LogLinearMappedSequence(new int[] { 0, 1, 2, 3 },
            dnaVocabulary);
    ...
    public void testRemoveAllGaps() throws Exception {
        ...
        final MappedSequence gacgac = dnaVocabulary.mapSequence("GACGAC")
            .insertGaps(new int[] { 0, 4, 4, 6 });
        assertEquals("GACGAC", dnaVocabulary.mapSequence(gacgac.removeAllGaps()));

        // Linguistic sequences
        LogLinearMappedSequence sequence = (LogLinearMappedSequence) new LogLinearMappedSequence(sentence1,
            vocabulary).insertGaps(new int[] { 0, 3, 5 });
    ...
    public void testToString() throws Exception {
        ...
        assertEquals(
            "The/_pos_DT computers/_pos_NNS will/_pos_MD display/_pos_VB stock/_pos_NN prices/_pos_NNS"
                    + " selected/_pos_VBN by/_pos_IN users/_pos_NNS ./_pos_.", sequence
