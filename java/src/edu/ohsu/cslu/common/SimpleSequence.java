...
public class SimpleSequence implements Sequence {
    ...
    /**
     * These abbreviations should generally not end sentences. The abbreviation list is taken from a sentence
     * splitter by Qiu Long (qiul@comp.nus.edu.sg), who in turn borrowed and modified a list from
     * mmunoz@uiuc.edu.
     */
    ...
    /**
     * Splits the sequence into sentences, based either on begin and end sentence tags (&lt;s&gt; and
     * &lt;/s&gt;) within the sequence itself or on a very simple set of sentence splitting rules.
     * 
    ...
    /**
     * A very simple rule-based sentence splitting implementation. Includes regex patterns based on those from
     * a sentence splitter by Qiu Long (qiul@comp.nus.edu.sg).
     * 
     * @return The current sequence split into sentences
     */
